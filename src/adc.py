...
class HMCAD1511(WishBoneDevice):
    ...
    DICT[0x26] = {
        "bits_custom1": 0b11111111 << 8,
    }
    DICT[0x27] = {
        "bits_custom2": 0b11111111 << 8,
    }
    DICT[0x2A] = {
        "cgain4_ch1": 0b1111 << 0,
        "cgain4_ch2": 0b1111 << 4,
    ...
    DICT[0x34] = {
        "fgain_branch1": 0b1111111 << 0,
        "fgain_branch2": 0b1111111 << 8,
    }
    DICT[0x35] = {
        "fgain_branch3": 0b1111111 << 0,
        "fgain_branch4": 0b1111111 << 8,
    }
    DICT[0x36] = {
        "fgain_branch5": 0b1111111 << 0,
        "fgain_branch6": 0b1111111 << 8,
    }
    DICT[0x37] = {
        "fgain_branch7": 0b1111111 << 0,
        "fgain_branch8": 0b1111111 << 8,
    }
    DICT[0x3A] = {
        "inp_sel_adc1": 0b11111 << 0,
        "inp_sel_adc2": 0b11111 << 8,
    }
    DICT[0x3B] = {
        "inp_sel_adc3": 0b11111 << 0,
    ...
    def _calFGainCfg(self, gain):
        x = np.float32(1 + abs((10 ** (gain / 20.0)) - 1))
...
class HMCAD1520(HMCAD1511):
    ...
    def __init__(self, interface, controller_name, cs=0xFF):
        ...
        self.DICT[0x26] = {
            "bits_custom1": 0xFFFF << 0,
        }
        self.DICT[0x27] = {
            "bits_custom2": 0xFFFF << 0,
        }
        self.DICT[0x31] = {
            "high_speed_mode": 0b111 << 0,
    ...
    def setOperatingMode(
        self, numChannel, clkDivide=1, lowClkFreq=False, resolution=12
    ):
